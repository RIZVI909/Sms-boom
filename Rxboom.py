...
# Author: Rizvi Ahmed 
# GitHub: https://github.com/RIZVI909
# Version:1.0
#########################################
...
def logo():
    ...
    print("\033[94m│     \033[92m  ___ __  __  ___  ___   ___  __  __         \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m  | _ \\ \/ / | _ )/ _ \ / _ \|  \/  | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m  |   / >  <  | _ \ (_) | (_) | |\/| | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m  |_|_\/_/\_\ |___/\___/ \___/|_|  |_|  \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : Rizvi Ahmed                 \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/RIZVI909 \033[94m│".center(columns+9))
